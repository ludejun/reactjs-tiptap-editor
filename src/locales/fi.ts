const locale = {
  ...
  'editor.more': 'Lisää työkaluja',
  'editor.importExport': 'Tuonti ja vienti',
  ...
  'editor.divider.tooltip': 'Erotin',
  'editor.divider.label.placeholder': 'Teksti',
  'editor.divider.variant.line': 'Viiva',
  'editor.divider.variant.dashed': 'Katkoviiva',
  'editor.divider.variant.dotted': 'Pisteviiva',
  'editor.divider.variant.double': 'Kaksoisviiva',
  'editor.divider.variant.short': 'Lyhyt viiva',
  'editor.divider.variant.dots': 'Kolme pistettä',
  'editor.divider.variant.stars': 'Tähdet',
  'editor.divider.variant.text': 'Tekstillä',
  'editor.divider.variant.number': 'Numeroitu',
  ...
  'editor.tooltip.rotate': 'Kierrä 90°',
  'editor.image.caption.add': 'Lisää kuvateksti',
  'editor.image.caption.remove': 'Poista kuvateksti',
  'editor.image.caption.placeholder': 'Kirjoita kuvateksti…',
  'editor.image.caption.default': 'Kuva {number}: ',
  ...
  'editor.notice.tooltip': 'Huomiolaatikko',
  'editor.notice.info': 'Tiedoksi',
  'editor.notice.success': 'Onnistui',
  'editor.notice.warning': 'Varoitus',
  'editor.notice.tip': 'Vinkki',
  'editor.notice.remove': 'Poista huomiolaatikko',
  'editor.notice.item.info': 'Tiedoksi-laatikko',
  'editor.notice.item.success': 'Onnistui-laatikko',
  'editor.notice.item.warning': 'Varoituslaatikko',
  'editor.notice.item.tip': 'Vinkkilaatikko',
  ...
  'editor.codeblock.auto': 'Tunnista automaattisesti',
  'editor.codeblock.search': 'Hae kieltä',
  'editor.codeblock.noResult': 'Kieltä ei löytynyt',
  'editor.imageUpload.altOptional': 'Vaihtoehtoinen teksti (valinnainen)',
  'editor.imageUpload.altHint': 'näytetään, jos kuva ei lataudu',
  'editor.imageUpload.dropzone': 'Valitse kuva napsauttamalla tai pudota se tähän',
  'editor.imageUpload.dropzoneActive': 'Pudota ladataksesi',
  'editor.imageUpload.dropzoneHint': '{formats} · enintään {size}',
  'editor.imageUpload.dropzoneHintMore': '{formats} ja muita · enintään {size}',
  'editor.imageUpload.linkHint': 'Liitä verkossa olevan kuvan osoite.',
  'editor.ai.title': 'Kysy tekoälyltä',
  'editor.ai.generate': 'Luo',
  'editor.ai.generate.katex': 'Kuvaile kaava, esim. toisen asteen ratkaisukaava',
  'editor.ai.generate.mermaid': 'Kuvaile kaavio, esim. kirjautumisen kulku',
  'editor.ai.close': 'Sulje',
  'editor.ai.prompt.label': 'Ohje tekoälylle',
  'editor.ai.prompt.placeholder': 'Kerro tekoälylle, mitä haluat…',
  'editor.ai.refine.label': 'Hienosäädä tulosta',
  'editor.ai.refine.placeholder': 'Kerro, mitä muuta pitää muuttaa…',
  'editor.ai.send': 'Lähetä',
  'editor.ai.stop': 'Lopeta luonti',
  'editor.ai.writing': 'Tekoäly kirjoittaa',
  'editor.ai.preview': 'Tekoälyn esikatselu',
  'editor.ai.retry': 'Yritä uudelleen',
  'editor.ai.discard': 'Hylkää',
  'editor.ai.apply': 'Käytä',
  'editor.ai.attach': 'Liitä',
  'editor.ai.attach.image': 'Lisää kuva',
  'editor.ai.attach.file': 'Lisää tiedosto',
  'editor.ai.attach.remove': 'Poista {name}',
  'editor.ai.error.noModel': 'Määritä tekoälymalli ennen pyynnön lähettämistä.',
  'editor.ai.error.protocol': 'Tekoälyprotokollaa ei tueta. Käytä arvoa openai tai anthropic.',
  'editor.ai.error.request':
    'Tekoälypyyntö epäonnistui ({status}). Tarkista malli, tunnistetiedot ja API-osoite.',
  'editor.ai.error.empty': 'Tekoäly ei palauttanut tekstiä. Kokeile toista ohjetta.',
  'editor.ai.error.generic': 'Tekstin luonti epäonnistui. Yritä uudelleen.',
  'editor.ai.error.fileTooBig': '{name} on suurempi kuin {size}.',
  'editor.ai.error.fileType': '{name} ei ole tuettu tiedostotyyppi.',
  'editor.ai.menu.edit': 'Muokkaa valintaa',
  'editor.ai.menu.generate': 'Luo',
  'editor.ai.menu.improve': 'Paranna tekstiä',
  'editor.ai.menu.grammar': 'Korjaa oikeinkirjoitus ja kielioppi',
  'editor.ai.menu.shorter': 'Lyhennä',
  'editor.ai.menu.longer': 'Pidennä',
  'editor.ai.menu.simplify': 'Yksinkertaista kieltä',
  'editor.ai.menu.tone': 'Vaihda sävyä',
  'editor.ai.menu.summarize': 'Tiivistä',
  'editor.ai.menu.explain': 'Selitä tämä',
  'editor.ai.menu.translate': 'Käännä',
  'editor.ai.menu.ask': 'Kysy tekoälyltä mitä tahansa…',
  'editor.ai.menu.trigger': 'Tekoäly',
};
