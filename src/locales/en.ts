const locale = {
  ...
  'editor.notice.item.info': 'Info notice',
  'editor.notice.item.success': 'Success notice',
  'editor.notice.item.warning': 'Warning notice',
  'editor.notice.item.tip': 'Tip notice',
