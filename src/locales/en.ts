const locale = {
  ...
  'editor.more.pinHint': 'Drag a tool onto the toolbar to keep it there.',
  'editor.more.pinned': 'On the Toolbar',
  'editor.more.unpin': 'Remove from Toolbar',
  ...
  'editor.iframe.tooltip': 'Embed',
  'editor.iframe.placeholder': 'Paste a link, or the <iframe> code from an Embed dialog',
  'editor.iframe.supported': 'Works with',
  'editor.iframe.invalid': 'That is not a link',
  'editor.iframe.insert': 'Insert',
  'editor.iframe.remove': 'Remove',
  'editor.iframe.kind.video': 'Video',
  'editor.iframe.kind.audio': 'Audio',
  'editor.iframe.kind.map': 'Maps',
  'editor.iframe.kind.design': 'Design',
  'editor.iframe.kind.board': 'Boards',
  'editor.iframe.kind.code': 'Code',
  'editor.iframe.kind.document': 'Documents',
  'editor.iframe.kind.form': 'Forms',
  ...
  'editor.notice.tooltip': 'Notice',
  'editor.notice.info': 'Info',
  'editor.notice.success': 'Success',
  'editor.notice.warning': 'Warning',
  'editor.notice.tip': 'Tip',
  'editor.notice.remove': 'Remove Notice',
