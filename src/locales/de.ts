const locale = {
  ...
  'editor.notice.item.info': 'Info-Hinweis',
  'editor.notice.item.success': 'Erfolgs-Hinweis',
  'editor.notice.item.warning': 'Warn-Hinweis',
  'editor.notice.item.tip': 'Tipp-Hinweis',
