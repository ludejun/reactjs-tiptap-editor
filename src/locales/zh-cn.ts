const locale = {
  ...
  'editor.edit': '编辑',
  'editor.settings': '设置',
  'editor.more.pinHint': '把工具拖到工具栏上即可常驻。',
  'editor.more.pinned': '已放到工具栏',
  'editor.more.unpin': '从工具栏移除',
  'editor.more': '更多工具',
  ...
  'editor.iframe.tooltip': '嵌入',
  'editor.iframe.placeholder': '粘贴链接，或“嵌入”对话框里的 <iframe> 代码',
  'editor.iframe.supported': '支持',
  'editor.iframe.invalid': '这不是一个链接',
  'editor.iframe.insert': '插入',
  'editor.iframe.remove': '移除',
  'editor.iframe.kind.video': '视频',
  'editor.iframe.kind.audio': '音频',
  'editor.iframe.kind.map': '地图',
  'editor.iframe.kind.design': '设计',
  'editor.iframe.kind.board': '白板与看板',
  'editor.iframe.kind.code': '代码',
  'editor.iframe.kind.document': '文档',
  'editor.iframe.kind.form': '表单',
  ...
  'editor.notice.tooltip': '提示块',
  'editor.notice.info': '信息',
  'editor.notice.success': '成功',
  'editor.notice.warning': '警告',
  'editor.notice.tip': '技巧',
  'editor.notice.remove': '移除提示块',
  ...
  'editor.ai.error.noModel': '发送请求前请先配置 AI 接口地址或模型。',
  'editor.ai.error.protocol': '不支持的 AI 协议，请使用 openai 或 anthropic。',
  'editor.ai.error.request': 'AI 请求失败（{status}），请检查接口地址、模型和凭证。',
