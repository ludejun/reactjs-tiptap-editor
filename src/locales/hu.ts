const locale = {
  ...
  'editor.notice.item.info': 'Információs doboz',
  'editor.notice.item.success': 'Siker doboz',
  'editor.notice.item.warning': 'Figyelmeztető doboz',
  'editor.notice.item.tip': 'Tipp doboz',
