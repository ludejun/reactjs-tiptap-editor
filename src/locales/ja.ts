const locale = {
  ...
  'editor.notice.tooltip': '注記',
  'editor.notice.info': '情報',
  'editor.notice.success': '成功',
  'editor.notice.warning': '警告',
  'editor.notice.tip': 'ヒント',
  'editor.notice.remove': '注記を解除',
  'editor.notice.item.info': '情報の注記',
  'editor.notice.item.success': '成功の注記',
  'editor.notice.item.warning': '警告の注記',
  'editor.notice.item.tip': 'ヒントの注記',
