const locale = {
  ...
  'editor.more': 'Công cụ khác',
  'editor.importExport': 'Nhập & xuất',
  ...
  'editor.divider.tooltip': 'Đường phân cách',
  'editor.divider.label.placeholder': 'Văn bản',
  'editor.divider.variant.line': 'Nét liền',
  'editor.divider.variant.dashed': 'Nét đứt',
  'editor.divider.variant.dotted': 'Chấm',
  'editor.divider.variant.double': 'Đôi',
  'editor.divider.variant.short': 'Nét ngắn',
  'editor.divider.variant.dots': 'Ba chấm',
  'editor.divider.variant.stars': 'Ngôi sao',
  'editor.divider.variant.text': 'Có chữ',
  'editor.divider.variant.number': 'Có số',
  ...
  'editor.tooltip.rotate': 'Xoay 90°',
  'editor.image.caption.add': 'Thêm chú thích',
  'editor.image.caption.remove': 'Xóa chú thích',
  'editor.image.caption.placeholder': 'Viết chú thích…',
  'editor.image.caption.default': 'Hình {number}: ',
  ...
  'editor.notice.tooltip': 'Khung thông báo',
  'editor.notice.info': 'Thông tin',
  'editor.notice.success': 'Thành công',
  'editor.notice.warning': 'Cảnh báo',
  'editor.notice.tip': 'Mẹo',
  'editor.notice.remove': 'Bỏ khung thông báo',
  'editor.notice.item.info': 'Khung thông tin',
  'editor.notice.item.success': 'Khung thành công',
  'editor.notice.item.warning': 'Khung cảnh báo',
  'editor.notice.item.tip': 'Khung mẹo',
  ...
  'editor.codeblock.auto': 'Tự động nhận diện',
  'editor.codeblock.search': 'Tìm ngôn ngữ',
  'editor.codeblock.noResult': 'Không tìm thấy ngôn ngữ',
  'editor.imageUpload.altOptional': 'Văn bản thay thế (tùy chọn)',
  'editor.imageUpload.altHint': 'hiển thị khi ảnh không tải được',
  'editor.imageUpload.dropzone': 'Nhấn để chọn ảnh, hoặc kéo ảnh vào đây',
  'editor.imageUpload.dropzoneActive': 'Thả để tải lên',
  'editor.imageUpload.dropzoneHint': '{formats} · tối đa {size}',
  'editor.imageUpload.dropzoneHintMore': '{formats} và nhiều hơn · tối đa {size}',
  'editor.imageUpload.linkHint': 'Dán địa chỉ của một ảnh trên web.',
  'editor.ai.title': 'Hỏi AI',
  'editor.ai.generate': 'Tạo',
  'editor.ai.generate.katex': 'Mô tả công thức, ví dụ: công thức nghiệm bậc hai',
  'editor.ai.generate.mermaid': 'Mô tả sơ đồ, ví dụ: luồng đăng nhập',
  'editor.ai.close': 'Đóng',
  'editor.ai.prompt.label': 'Câu lệnh cho AI',
  'editor.ai.prompt.placeholder': 'Nói cho AI biết bạn muốn gì…',
  'editor.ai.refine.label': 'Tinh chỉnh kết quả',
  'editor.ai.refine.placeholder': 'Cho AI biết cần sửa gì thêm…',
  'editor.ai.send': 'Gửi',
  'editor.ai.stop': 'Dừng tạo',
  'editor.ai.writing': 'AI đang viết',
  'editor.ai.preview': 'Xem trước của AI',
  'editor.ai.retry': 'Thử lại',
  'editor.ai.discard': 'Bỏ',
  'editor.ai.apply': 'Áp dụng',
  'editor.ai.attach': 'Đính kèm',
  'editor.ai.attach.image': 'Thêm ảnh',
  'editor.ai.attach.file': 'Thêm tệp',
  'editor.ai.attach.remove': 'Xóa {name}',
  'editor.ai.error.noModel': 'Hãy cấu hình mô hình AI trước khi gửi yêu cầu.',
  'editor.ai.error.protocol': 'Giao thức AI không được hỗ trợ. Hãy dùng openai hoặc anthropic.',
  'editor.ai.error.request':
    'Yêu cầu AI thất bại ({status}). Kiểm tra mô hình, thông tin xác thực và địa chỉ API.',
  'editor.ai.error.empty': 'AI không trả về nội dung. Hãy thử câu lệnh khác.',
  'editor.ai.error.generic': 'Không tạo được nội dung. Vui lòng thử lại.',
  'editor.ai.error.fileTooBig': '{name} lớn hơn {size}.',
  'editor.ai.error.fileType': '{name} không phải định dạng được hỗ trợ.',
  'editor.ai.menu.edit': 'Chỉnh sửa vùng chọn',
  'editor.ai.menu.generate': 'Tạo nội dung',
  'editor.ai.menu.improve': 'Cải thiện câu chữ',
  'editor.ai.menu.grammar': 'Sửa chính tả & ngữ pháp',
  'editor.ai.menu.shorter': 'Rút gọn',
  'editor.ai.menu.longer': 'Mở rộng',
  'editor.ai.menu.simplify': 'Diễn đạt đơn giản',
  'editor.ai.menu.tone': 'Đổi giọng văn',
  'editor.ai.menu.summarize': 'Tóm tắt',
  'editor.ai.menu.explain': 'Giải thích',
  'editor.ai.menu.translate': 'Dịch',
  'editor.ai.menu.ask': 'Hỏi AI bất cứ điều gì…',
