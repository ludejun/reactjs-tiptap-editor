...
computed specifier, so ``import(`reactjs-tiptap-editor/locales/${code}`)`` either
...
const LANGUAGES: { code: string; label: string; load?: Loader }[] = [
  ...
  { code: 'zh_CN', label: '中文', load: () => import('reactjs-tiptap-editor/locales/zh-cn') },
  { code: 'hi', label: 'हिन्दी', load: () => import('reactjs-tiptap-editor/locales/hi') },
  { code: 'es', label: 'Español', load: () => import('reactjs-tiptap-editor/locales/es') },
  { code: 'fr', label: 'Français', load: () => import('reactjs-tiptap-editor/locales/fr') },
  { code: 'bn', label: 'বাংলা', load: () => import('reactjs-tiptap-editor/locales/bn') },
  { code: 'pt_BR', label: 'Português', load: () => import('reactjs-tiptap-editor/locales/pt-br') },
  { code: 'ru', label: 'Русский', load: () => import('reactjs-tiptap-editor/locales/ru') },
  { code: 'id', label: 'Bahasa Indonesia', load: () => import('reactjs-tiptap-editor/locales/id') },
  { code: 'de', label: 'Deutsch', load: () => import('reactjs-tiptap-editor/locales/de') },
  { code: 'ja', label: '日本語', load: () => import('reactjs-tiptap-editor/locales/ja') },
  { code: 'tr', label: 'Türkçe', load: () => import('reactjs-tiptap-editor/locales/tr') },
  { code: 'vi', label: 'Tiếng Việt', load: () => import('reactjs-tiptap-editor/locales/vi') },
  { code: 'ko', label: '한국어', load: () => import('reactjs-tiptap-editor/locales/ko') },
  { code: 'it', label: 'Italiano', load: () => import('reactjs-tiptap-editor/locales/it') },
  { code: 'hu_HU', label: 'Magyar', load: () => import('reactjs-tiptap-editor/locales/hu') },
  { code: 'fi', label: 'Suomi', load: () => import('reactjs-tiptap-editor/locales/fi') },
];
