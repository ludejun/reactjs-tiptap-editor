...
| 块       | `heading`、`bulletList`、`orderedList`、`taskList`、`blockquote`、`table`、`divider`、`details`、`codeBlock`、`callout`、`notice`、`tableOfContents`、`column`（React 默认开启；Vue 需显式开启）                                    | `horizontalRule`（分割线已取代它）                                                                                                                                       |
