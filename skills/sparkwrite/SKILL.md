---
name: sparkwrite
description: Integrate, configure, debug, migrate, refactor, and review React editors using sparkwrite. Use for its provider, extensions, toolbars, bubble menus, uploads, persistence, localization, theme, and document import/export. Applies when this package is requested or already used, not to generic Tiptap integrations using other UI libraries.
---
